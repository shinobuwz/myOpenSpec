...
- Git 状态按 `~/.opsx/common/git-lifecycle.md` 检查，用于判断证据 freshness
...
4. 按 `~/.opsx/common/git-lifecycle.md` 记录验证时的 `HEAD` 和 diff 状态。
5. 按 `references/reviewer-prompt.md` 执行 Spec Compliance Review 和验证维度检查。
