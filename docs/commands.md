...
| `/opsx:bugfix` | 使用精简流程快速修复明确缺陷 |
| `/opsx:knowledge` | 独立沉淀可复用经验到知识库 |
| `/opsx:new` | 开始一个新变更 |
...
使用精简 bugfix 流程修复明确缺陷。

**语法：**
```
/opsx:bugfix [bug description]
```
...
独立沉淀一次工作中的可复用经验，不要求先归档或维护 change 文档。

**语法：**
```
/opsx:knowledge [summary]
```
