...
>
> 直接让 AI 使用 `opsx-plan` 或 `opsx-explore` 开始。→ [在此了解更多](docs/opsx.md)
...
→ **[技能参考](docs/commands.md)**：OPSX skills 与用法<br>
...
**使用反馈** —— 如需记录问题或改进建议，可运行 `openspec-cn feedback "标题" --body "详细说明"`，会在当前项目生成本地反馈文件。
