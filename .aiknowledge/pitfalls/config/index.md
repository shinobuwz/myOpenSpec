...
| [run-report-data.json 只存判定结果，不存上下文副本](run-report-json-separation-of-concerns.md) | superseded | 2026-04-14 | 已被 misc/artifact-as-source-of-truth 替代：run-report-data.json 和 packet-*.json 均已删除，直接读产物文件 |
